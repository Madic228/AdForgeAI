            ...
            if edit == 'да':
                ...
                while True:
                    ...
                    if choice == 1:
                        ...
                        # Получение версии объявления
                        ads = ad_manager.load_ad_version_from_json()
                        if ads:
                            for i, ad in enumerate(ads):
                                if ad["headline"] == ad_manager.headline and ad["audience"] == ad_manager.audience:
                                    print(f"\nВерсия объявления: {ads[i]['version']}")
                                    break
                    elif choice == 6:
                        break
        elif choice == '2':
                ...
                try:
                    ...
                    if 0 <= ad_index < len(ads):
                        ...
                        while True:
                            ...
                            if ads:
                                for i, ad in enumerate(ads):
                                    if ad["headline"] == ad_manager.headline and ad[
                                        "audience"] == ad_manager.audience:
                                        print(f"\nВерсия объявления: {ads[i]['version']}")
                            print(f"Модель: {editor.ad_manager.model_name}")
                            print(f"Потоковая обработка: {'Вкл' if editor.ad_manager.stream else 'Выкл'}")
                            print(f"Температура: {editor.ad_manager.temperature}")
